...
/**
 * This is the model class for table "services_link".
 *
 * The followings are the available columns in table 'services_link':
 * @property string $id
 * @property string $service_id
 */
class ServicesLink extends CActiveRecord
{
	/**
	 ...
	 * @return ServicesLink the static model class
	 */
